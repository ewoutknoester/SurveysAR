...
Bioplot <- ggplot(data = biosumsubtransmeans.2021, aes(x = ReefType, y = Biomass_ha, colour = ReefType))+
    ...
    geom_text(data=emmBiosum.2021, aes(label = .group, y = response + 2*SE), colour = 'black', size = 7)+
...
## Select subsets
bio.ord.years <- subset(bio.ord, ReefType == "Ref (+)")
